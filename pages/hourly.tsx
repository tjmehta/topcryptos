...
const HourlyPageContent = dynamic(() => import('../components/HourlyPageContent'), {
  ssr: false,
  loading: () => (
    <div className="text-gray-200" style={{ height: '100%', fontFamily: 'Helvetica' }}>
      <Head>
        <title>Top Cryptos - Top Performing Cryptocurrencies (Hourly)</title>
